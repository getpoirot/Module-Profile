    ...
    extends aAction
{
    ...
    function __invoke($token = null, $request_id = null)
    {
        ...
        if ( (string) $followRequest->getIncoming() != (string) $token->getOwnerIdentifier() )
            throw new \Exception('Bad Request.', 400);

        // Persist entity
        if ($followRequest->getStat() != EntityFollow::STAT_ACCEPTED) {
            $followRequest->setStat(EntityFollow::STAT_ACCEPTED);
